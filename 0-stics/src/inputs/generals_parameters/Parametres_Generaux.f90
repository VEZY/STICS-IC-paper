...
! --      read (36,*,iostat=eof,end=150) codeulaivernal
  ...
  read (36,*)
  read (36,fmt='(A1)', iostat=eof,end=150) pg%P_separateurrapport
  read (36,*)
...
! dr 08/11/2016 mis dans le formalisme nit  et denit
!  read (36,*)
...
! dr 08/11/2016 mis dans le formalisme nit
  read (36,*)
  read (36,*,iostat=eof,end=150) pg%P_hminn
  read (36,*)
  read (36,*,iostat=eof,end=150) pg%P_hoptn
...
!  read (36,*,iostat=eof,end=150) pg%P_fnx
  ...
  read (36,*,iostat=eof,end=150) pg%P_pHmaxnit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_nh4_min
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_pHminden
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_pHmaxden
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_wfpsc
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_tdenitopt_gauss
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_scale_tdenitopt
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_Kd
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_kdesat
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_vnit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_fnx
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_vnitmax
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_Kamm
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_tnit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_tnitmin
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_tnitopt
      ...
      read (36,*,iostat=eof,end=150) pg%P_tnitmax
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_tnitopt_gauss
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_scale_tnitopt
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_rationit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_rationit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_hourly_wfps_nit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_pdenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_cmin_pdenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_cmax_pdenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_min_pdenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_max_pdenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_ratiodenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_ratiodenit
      read (36,*)
      read (36,*,iostat=eof,end=150) pg%P_code_hourly_wfps_denit
!!
