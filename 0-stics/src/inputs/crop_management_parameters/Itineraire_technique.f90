...
! fin record
    ...
    ! Ouverture du fichier pour lecture
      !open (36,file=P_ftec,status='old',iostat=eof)
      open (36,file = filepluspath,status = 'old',iostat=eof) ! enabling_record
...
!***************************
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbjres
      if (itk%P_nbjres > 0) then
        do i = 1,itk%P_nbjres
          read (36,*)
          read (36,*,iostat=eof) itk%P_julres(i),itk%P_coderes(i), &
...
!******************
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbjtrav
      if (itk%P_nbjtrav > 0) then
        do i = 1,itk%P_nbjtrav
          read (36,*)
          read (36,*,iostat=eof) itk%P_jultrav(i),itk%P_profres(i),itk%P_proftrav(i)
        end do
      endif
!sowing
!*****************
      read (36,*)
      read (36,*,iostat=eof) itk%P_iplt0
      read (36,*)
      read (36,*,iostat=eof) itk%P_profsem
      read (36,*)
    ! DR 27/08/07 on renomme densite P_densitesem car densite varie
      read (36,*,iostat=eof) itk%P_densitesem
      read (36,*)
      read (36,*,iostat=eof) itk%P_variete
      read (36,*)
      read (36,*,iostat=eof) itk%P_codetradtec
      read (36,*)
      read (36,*,iostat=eof) itk%P_interrang
      read (36,*)
      read (36,*,iostat=eof) itk%P_orientrang
    ! DR 23/10/07 lecture des options de semis
      read (36,*)
      read (36,*,iostat=eof) itk%P_codedecisemis
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbjmaxapressemis
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbjseuiltempref
!phenological stages
      read (36,*)
      read (36,*,iostat=eof) itk%P_codestade
      read (36,*)
      read (36,*,iostat=eof) itk%P_ilev
      read (36,*)
      read (36,*,iostat=eof) itk%P_iamf
      read (36,*)
      read (36,*,iostat=eof) itk%P_ilax
      read (36,*)
      read (36,*,iostat=eof) itk%P_isen
      read (36,*)
      read (36,*,iostat=eof) itk%P_ilan
      read (36,*)
      read (36,*,iostat=eof) itk%P_iflo
      read (36,*)
      read (36,*,iostat=eof) itk%P_idrp
      read (36,*)
      read (36,*,iostat=eof) itk%P_imat
      read (36,*)
      read (36,*,iostat=eof) itk%P_irec
      read (36,*)
      read (36,*,iostat=eof) itk%P_irecbutoir
! irrigation
!***************************
      read (36,*)
      read (36,*,iostat=eof) itk%P_effirr
      read (36,*)
      read (36,*,iostat=eof) itk%P_codecalirrig
      read (36,*)
      read (36,*,iostat=eof) itk%P_ratiol
      read (36,*)
      read (36,*,iostat=eof) itk%P_dosimx
    ! DR 23/10/07
      read (36,*)
      read (36,*,iostat=eof) itk%P_doseirrigmin
    !
    ! DR 23/10/07
      read (36,*)
      read (36,*,iostat=eof) itk%P_codedateappH2O
    !
      read (36,*)
      read (36,*,iostat=eof) itk%nap
      ...
      if (itk%nap > 0) then
        do i = 1,itk%nap
          if (itk%P_codedateappH2O /= 1) then
            read (36,*)
            read (36,*,iostat=eof) itk%P_julapI(i), itk%P_doseI(i)
          else
            read (36,*)
            read (36,*,iostat=eof) itk%P_upvttapI(i),itk%P_doseI(i)
          endif
        end do
      endif

      read (36,*)
      read (36,*,iostat=eof) itk%P_codlocirrig
      read (36,*)
      read (36,*,iostat=eof) itk%P_locirrig
      read (36,*)
      read (36,*,iostat=eof) itk%P_profmes
      !fertilisation
!************************
      read (36,*)
      if(itk%flag_plusieurs_engrais)then
          ...
          read (36,*,iostat=eof) itk%P_engrais(1)
      endif
      read (36,*)
      read (36,*,iostat=eof) itk%P_concirr
    ! DR 23/10/07 on deplace P_codedateappn ici pour la lecture suivant code
      read (36,*)
      read (36,*,iostat=eof) itk%P_codedateappN
    ! DR 2/07/08 on rajoute 2 parametres pour permettre le fractionnent de l'azote
      read (36,*)
      read (36,*,iostat=eof) itk%P_codefracappN
      read (36,*)
      read (36,*,iostat=eof) itk%P_Qtot_N
    !
      read (36,*)
      read (36,*,iostat=eof) itk%napN
    ! *- lecture des fertilisations
        ...
        do i = 1,itk%napN
          if (itk%P_codedateappN /= 1) then
            if (itk%P_codefracappN == 1) then
              read (36,*)
              if(itk%flag_plusieurs_engrais)then
                  read (36,*,iostat=eof) itk%P_julapN(i), itk%P_doseN(i),itk%P_engrais(i)
              else
                  read (36,*,iostat=eof) itk%P_julapN(i), itk%P_doseN(i)
              endif
            else
              read (36,*)
              if(itk%flag_plusieurs_engrais)then
                  read (36,*,iostat=eof) itk%P_julapN(i), itk%P_fracN(i),itk%P_engrais(i)
              else
                  read (36,*,iostat=eof) itk%P_julapN(i), itk%P_fracN(i)
              endif
            endif
          else
            if (itk%P_codefracappN == 1) then
              read (36,*)
              if(itk%flag_plusieurs_engrais)then
                  read (36,*,iostat=eof) itk%P_upvttapN(i), itk%P_doseN(i),itk%P_engrais(i)
              else
                  read (36,*,iostat=eof) itk%P_upvttapN(i), itk%P_doseN(i)
              endif
            else
              read (36,*)
              if(itk%flag_plusieurs_engrais)then
                  read (36,*,iostat=eof) itk%P_upvttapN(i), itk%P_fracN(i),itk%P_engrais(i)
              else
                  read (36,*,iostat=eof) itk%P_upvttapN(i), itk%P_fracN(i)
              endif
            endif
          endif
        end do
      ...
      read (36,*)
      read (36,*,iostat=eof) itk%P_codlocferti
      read (36,*)
      read (36,*,iostat=eof) itk%P_locferti
! DR 05/04/2011 on les passe dans paramv6 : sc%P_codecalferti,sc%P_ratiolN,sc%P_dosimxN
!      read (36,*)
!      read (36,*,iostat=eof) sc%P_codetesthumN      ! => Stics_Communs ?? A classer ou dupliquer
      read (36,*)
      read (36,*,iostat=eof) itk%P_ressuite
! harvest
!***************************
      read (36,*)
      read (36,*,iostat=eof) itk%P_codcueille
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbcueille
      read (36,*)
      read (36,*,iostat=eof) itk%P_cadencerec
      read (36,*)
      read (36,*,iostat=eof) itk%P_codrecolte
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeaumin
      read (36,*)
      read (36,*,iostat=eof) itk%P_h2ograinmin
      read (36,*)
      read (36,*,iostat=eof) itk%P_h2ograinmax
      read (36,*)
      read (36,*,iostat=eof) itk%P_sucrerec
      read (36,*)
      read (36,*,iostat=eof) itk%P_CNgrainrec
      read (36,*)
      read (36,*,iostat=eof) itk%P_huilerec
    ! DR 23/10/07
      read (36,*)
      read (36,*,iostat=eof) itk%P_coderecolteassoc
      read (36,*)
      read (36,*,iostat=eof) itk%P_codedecirecolte
      read (36,*)
      read (36,*,iostat=eof) itk%P_nbjmaxapresrecolte
!special techniques
!*****************************
      read (36,*)
      read (36,*,iostat=eof) itk%P_codefauche
...
!    if(.not.itk%flag_pature)then
      read (36,*)
      read (36,*,iostat=eof) itk%P_mscoupemini(1)
!    endif
      read (36,*)
      read (36,*,iostat=eof) itk%P_codemodfauche
      read (36,*)
      ...
      read (36,*,iostat=eof) itk%P_hautcoupedefaut
      read (36,*)
      read (36,*,iostat=eof) itk%P_stadecoupedf
      read (36,*)
      read (36,*,iostat=eof) nbcoupe2
      if (itk%P_codemodfauche == 2) then
    ! *- on lit des jours
        do i = 1,nbcoupe2
          read (36,*)
          if(itk%flag_pature)then
            read (36,*,iostat=eof) itk%P_julfauche(i),itk%P_hautcoupe(i),itk%P_lairesiduel(i),itk%P_msresiduel(i), &
                                   itk%P_anitcoupe(i), itk%P_restit(i),itk%P_mscoupemini(i)
          else
            read (36,*,iostat=eof) itk%P_julfauche(i),itk%P_hautcoupe(i),itk%P_lairesiduel(i),itk%P_msresiduel(i),itk%P_anitcoupe(i)
          endif
        end do
      ...
      read (36,*)
      read (36,*,iostat=eof) nbcoupe3
      if(itk%P_codemodfauche == 3) then
    ! *- on lit des degrés.jours
        do i = 1,nbcoupe3
          read (36,*)
          if(itk%flag_pature)then
          read (36,*,iostat=eof) itk%P_tempfauche(i),itk%P_hautcoupe(i),itk%P_lairesiduel(i),itk%P_msresiduel(i),  &
                                 itk%P_anitcoupe(i),itk%P_restit(i),itk%P_mscoupemini(i)
          else
          read (36,*,iostat=eof) itk%P_tempfauche(i),itk%P_hautcoupe(i),itk%P_lairesiduel(i),itk%P_msresiduel(i),itk%P_anitcoupe(i)
          endif
        end do
    ...
    ! ** version <5.0
    ! --     read (36,*)
    ! --     read (36,*,iostat=eof) itk%P_codeffeuil
    ! --     read (36,*)
    ! --     read (36,*,iostat=eof) itk%P_effeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_codepaillage
    ! TODO: ici, on testait le code paillage de la plante principale uniquement. Pb ?
      read (36,*)
      read (36,*,iostat=eof) itk%P_couvermulchplastique
      read (36,*)
      read (36,*,iostat=eof) itk%P_albedomulchplastique
      read (36,*)

    ! -- déplacé -- read (36,*,iostat=eof) itk%P_ressuite

    ! ** version 5.0
      read (36,*,iostat=eof) itk%P_codrognage
      read (36,*)
      read (36,*,iostat=eof) itk%P_largrogne
      read (36,*)
      read (36,*,iostat=eof) itk%P_hautrogne
      read (36,*)
      read (36,*,iostat=eof) itk%P_biorognem
      read (36,*)
      read (36,*,iostat=eof) itk%P_codcalrogne
      read (36,*)
      read (36,*,iostat=eof) itk%P_julrogne
      read (36,*)
      read (36,*,iostat=eof) itk%P_margerogne
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeclaircie
      read (36,*)
      ...
      read (36,*,iostat=eof) itk%P_nb_eclair
         do i = 1,itk%P_nb_eclair
         read (36,*)
         read (36,*,iostat=eof) itk%P_juleclair(i), itk%P_nbinfloecl(i)
         enddo
      else
         itk%P_nb_eclair=1
         read (36,*,iostat=eof) itk%P_juleclair(1)
         read (36,*)
         read (36,*,iostat=eof) itk%P_nbinfloecl(1)
      endif
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeffeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_codhauteff
      read (36,*)
      read (36,*,iostat=eof) itk%P_codcaleffeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_laidebeff
      read (36,*)
      read (36,*,iostat=eof) itk%P_effeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_juleffeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_laieffeuil
      read (36,*)
      read (36,*,iostat=eof) itk%P_codetaille
      read (36,*)
      read (36,*,iostat=eof) itk%P_jultaille
    ! DR 23/10/07
      read (36,*)
      read (36,*,iostat=eof) itk%P_codepalissage
      read (36,*)
      read (36,*,iostat=eof) itk%P_hautmaxtec
      read (36,*)
      read (36,*,iostat=eof) itk%P_largtec
    !
      read (36,*)
      read (36,*,iostat=eof) itk%P_codabri
      read (36,*)
      read (36,*,iostat=eof) itk%P_transplastic
      read (36,*)
      read (36,*,iostat=eof) itk%P_surfouvre1
      read (36,*)
      read (36,*,iostat=eof) itk%P_julouvre2
      read (36,*)
      read (36,*,iostat=eof) itk%P_surfouvre2
      read (36,*)
      read (36,*,iostat=eof) itk%P_julouvre3
      read (36,*)
      read (36,*,iostat=eof) itk%P_surfouvre3
    ! DR 23/10/07
!soil modification by techniques (compaction-fragmentation)
!************************************************************
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeDST
      read (36,*)
      read (36,*,iostat=eof) itk%P_dachisel
      read (36,*)
      read (36,*,iostat=eof) itk%P_dalabour
      read (36,*)
      read (36,*,iostat=eof) itk%P_rugochisel
      read (36,*)
      read (36,*,iostat=eof) itk%P_rugolabour
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeDSTtass
      read (36,*)
      read (36,*,iostat=eof) itk%P_profhumsemoir
      read (36,*)
      read (36,*,iostat=eof) itk%P_dasemis
      read (36,*)
      read (36,*,iostat=eof) itk%P_profhumrecolteuse
      read (36,*)
      read (36,*,iostat=eof) itk%P_darecolte
      read (36,*)
      read (36,*,iostat=eof) itk%P_codeDSTnbcouche
...
! tests sur les apports de residus
    ...
    ! le 22/07/99 test sur P_locirrig=0
      if (itk%P_codlocirrig == 3 .and. itk%P_locirrig <= 0.0) then
