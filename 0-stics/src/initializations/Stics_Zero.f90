...
! *- apports
 ...
 sc%CO2res = 0.0
  sc%CO2hum = 0.0
  sc%CO2sol = 0. ! Bruno d�plac�s depuis Sol
...
! DR 28/12/2016   sc%nbcoupe_an1(:) = 0
!  sc%julfauche_an1(:,:) = 0
...
! DR + Bruno on ajoute des variables de sorties sur les residus
 ...
 ! DR 11/12/2013 ajout des varaibles cumul�es depuis le semis (pour Macsur)
  sc%drain_from_plt = 0.
...
!DR 30/09/2016 on en ajoute une autre pour la caler avce des obs
  sc%HR_vol_1_10 = 0.
  sc%HR_vol_1_30 = 0.
  sc%HR_vol_31_60 = 0.
  sc%HR_vol_61_90 = 0.
