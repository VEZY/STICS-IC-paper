...
!          write(*,*)i,'avant',pdsfruit(i),poids_tot_avant_eclai
      !
          if (nfruit(i) <= 0.0) CYCLE
          pdsfruit(i) = pdsfruit(i) / nfruit(i)
...
!          write(*,*)i,'apres',pdsfruit(i),poids_tot_apres_eclai
        end do
      endif
!    write(*,*)'masec',masec, poids_tot_avant_eclai,poids_tot_apres_eclai
