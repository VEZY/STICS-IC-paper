...
subroutine calapNenUpvt(n,nplt,P_upvttapN,P_codefracappN,P_doseN,P_fracN,P_Qtot_N,nlev,upvt,jul,  &
  ...
  integer, intent(IN)    :: P_upvttapN(300)   !  // PARAMETER // thermal time from emergence (UPVT units) driving fertilization // degree C // PARTEC // 1
  integer, intent(IN)    :: P_codefracappN  ! // PARAMETER // option of cut modes for forage crops: yes (1), no (2) // code 1/2 // PARTEC // 0 
  real,    intent(IN)    :: P_doseN(300)      ! pareil que pour P_upvttapN, quelle dimension ? 300 par défaut 	  // PARAMETER // fertilizer amount // kgN.jour-1 // PARTEC // 1 
  real,    intent(IN)    :: P_fracN(300)      ! pareil que pour P_upvttapN, quelle dimension ? 300 par défaut 	  // PARAMETER // percentage of P_Qtot_N applied // % // PARTEC // 1 
  ...
  integer, intent(INOUT) :: P_julapN(300)     ! pareil que pour P_upvttapN, quelle dimension ? 300 par défaut 	  // PARAMETER // dates in julian days of fertilizer application // julian day // PARTEC // 1 
