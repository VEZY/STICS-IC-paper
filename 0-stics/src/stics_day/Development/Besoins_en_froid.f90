...
! DR 20/07/2012 on a plus besoin de jjul
                  nbjanrec,nrecbutoir,P_tfroid,P_ampfroid,P_codedormance,thor,cu_min,cu_veille,cu,ndebdorm,n,P_q10,tmin,tmax)
...
subroutine Vernalisation(tdev,P_jvc,P_jvcmini,P_codeperenne,P_culturean,P_codeinitprec,nbjanrec,P_tfroid,P_ampfroid,n, & !IN
                         rfvi,nrecbutoir,maxwth,caljvc,etatvernal)                                              ! OUT
